...
function App() {
  ...
  //   setCells(prevCells =>
  //     prevCells.map(c =>
  //       c.id === id ? { ...c, isExecuting: true, output: '', error: undefined, images: undefined } : c
  //     )
  //   );
  ...
  //     // Handle input prompts (live input feature)
  //     while (result?.requiresInput) {
  //       const userInput = prompt(result.inputPrompt || 'Enter input:') || ''; // Ask user for input
  //       result = await executeCode(cell.content, userInput); // Re-run with input
  //     }
  ...
  //     // Handle input prompts (if needed)
  //     while (result?.requiresInput) {
  //       const userInput = prompt(result.inputPrompt || "Enter input:") || ""; // Ask user for input
  //       result = await executeCode(cell.content, userInput); // Re-run with input
  //     }
